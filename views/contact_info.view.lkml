view: contact_info {
  sql_table_name: v310load_new.contact_info ;;
  ...
  measure: count {
    type: count
    drill_fields: [contact_info_id, entity.entity_name, entity.display_name, entity.tablespace_name, entity.audit_view_entity_id]
  }
}
